...
namespace TeamWork.Common.ConstantStrings
{
    public class Constants
    {

        public static readonly string Group = "Group";
        public static readonly string NoAccount = " have no account!";
        public static readonly string AreTeachers = " are teachers!";
        public static readonly string IsTeacher = " is teacher!";
        ...
        public static readonly string ReturnedGradeForGroups = "{0} returned {1} for one of your group's tasks.";
